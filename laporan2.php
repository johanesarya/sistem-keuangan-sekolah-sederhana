                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Data Pemakaian Anggaran:</h6>
                        </div>

                        <!-- Card Body -->
                        <div class="card-body">
                            <?php
                            $jumlah=mysqli_query($conn,"SELECT COUNT(*) as id from tbl_realisasi where jenjang='".$_SESSION['jenjang']."'");
                             ...
                             <div class="row mt-3">
                                <div class="col-md-8  mt-4">
                                    <h7 class="m-0 font-weight-bold">Pemakaian Anggaran di Tabel: <?php echo $kap." Max"; ?></h7><br>
                                    <a href="downloadrealisasi.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Laporan</a>
                                </div>
                            </div>
                            ...
                            if(isset($_GET['cari'])){
                                ...
                                $search=mysqli_query($conn, "select * from tbl_realisasi limit $start, $hal");
                            }
                            if(mysqli_num_rows($search)){
                                while($row = mysqli_fetch_array($search)){
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><?php echo $row['id_realisasi'] ?></th>
