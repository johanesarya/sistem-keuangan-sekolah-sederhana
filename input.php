                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Catat Anggaran:</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                            <form action='simpaninput.php' name='kirim' method='post'>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label>Agenda Kegiatan</label>
                                        <input class="form-control form-control-sm" type="text" placeholder="nama kegiatan" aria-label=".form-control-sm example" name='keterangan' required>
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Jumlah Anggaran</label>
                                        <input class="form-control form-control-sm" type="number" placeholder="Jumlah Uang..." aria-label=".form-control-sm example" name='nilai' required>
                                   </div>                          
                                    <div class="col-sm-4">
